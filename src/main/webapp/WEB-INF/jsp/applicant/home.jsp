...
<html lang="en">
	...
	<body>
				...
				<div id="newJobs2">
					...
					<div class="newApply">
						<table>	
							...
							<tr>
								<td>企业:<a target="_blank" href="${absolutePath}/companydetail/detail?id=${job.getCompanyid()}&from=applicationHome">${job.getCompanyname()}</a></td>
								<td>职位:<a target="_blank" href="${absolutePath}/job/detail?id=${job.getId()}&from=applicationHome">${job.getName()} </a></td>
				...
				<div id="newsDiv">
					...
					<div class="news">
						<table>
							...
							<tr>
								<td>
									<img src="${absolutePath}/images/item.gif"><a target="_blank" href="${absolutePath}/new/detail?id=${news.getId()}&from=applicationHome">${news.getTitle()}</a>
								</td>
		...
		function search(){
			...
			window.location.href="${absolutePath}/job/search?name="+name+"&from=applicationHome";
		}
		...
		function showTotal(){	
			document.getElementById("newJobs2").style.display = "block";
			document.getElementById("jobsList2").style.display = "none";
			document.getElementById("a1").style.color="#00c000";
		}
		function showApplyList(category) {
			document.getElementById("newJobs2").style.display="none";
			document.getElementById("jobsList2").style.display="block";
